...
CONSTRAINT montant_OPERATION CHECK( montantoper <> 0 AND montantoper >= -1000 AND montantoper <= 1000 ));
...
INSERT INTO TYPEOPERATION VALUES ((SELECT nvl (MAX( numtypeoper),0) + 1 FROM TYPEOPERATION),'dépot en espèce');
